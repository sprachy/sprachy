...
ALTER TABLE ONLY public.patterns DROP CONSTRAINT patterns_slug_key;
...
--
-- Name: patterns; Type: TABLE; Schema: public; Owner: supabase_admin
--
...
ALTER TABLE public.patterns OWNER TO supabase_admin;

--
-- Name: TABLE patterns; Type: COMMENT; Schema: public; Owner: supabase_admin
--

COMMENT ON TABLE public.patterns IS 'Learny patterns for German!';


--
-- Name: patterns_id_seq; Type: SEQUENCE; Schema: public; Owner: supabase_admin
--
...
--
-- Name: patterns patterns_pkey; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: patterns patterns_slug_key; Type: CONSTRAINT; Schema: public; Owner: supabase_admin
--
...
--
-- Name: patterns; Type: ROW SECURITY; Schema: public; Owner: supabase_admin
--
...
--
-- Name: TABLE patterns; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON TABLE public.patterns TO postgres;
...
--
-- Name: SEQUENCE patterns_id_seq; Type: ACL; Schema: public; Owner: supabase_admin
--

GRANT ALL ON SEQUENCE public.patterns_id_seq TO postgres;
